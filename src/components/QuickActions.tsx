    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-2">
        {actions.map((action) => {
          ...
          return (
            <button key={action.id} className={`group flex flex-col items-center justify-center p-3 rounded-xl transition-all duration-300 border ${isDark ? 'bg-neutral-900 border-neutral-700 hover:border-neutral-500 hover:bg-neutral-800' : 'bg-white shadow-sm border-neutral-100 hover:shadow-md hover:border-neutral-200'}`}>
